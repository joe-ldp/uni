...
class Dot
{
  ...
  public void Update()
  {
    Point nearest = points.get(PApplet.parseInt(random(points.size())));
...
int potato = 255 / PApplet.parseInt(random(4, 10));
...
class Point
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "sketch_2" };
    if (passedArgs != null) {
